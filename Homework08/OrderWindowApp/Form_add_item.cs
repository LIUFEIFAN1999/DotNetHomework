...
namespace OrderWindowApp
{
    public partial class Form_add_item : Form
    {
        ...
        {
            new Goods("apple", 5.4),
            new Goods("banana", 5.0),
            new Goods("blueberry", 19.98),
            new Goods("cherry", 20),
            new Goods("grape", 8),
            new Goods("kiwi", 8),
            new Goods("litchi", 6),
            new Goods("mango", 12),
            new Goods("mangosteen", 15),
            new Goods("orange", 5),
            new Goods("peach", 6),
            new Goods("pear", 4),
            new Goods("pineapple", 4),
            new Goods("pitaya", 8),
            new Goods("strawberry", 20),
            new Goods("watermelon", 9)
        };
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            Goods selectedGoods = goodsList.Where(goods => goods.Name == name).FirstOrDefault();
            int count = (int) this.GetType().GetProperty(propertyName).GetValue(this);
            itemList.Add(new OrderDetails(selectedGoods, count));
